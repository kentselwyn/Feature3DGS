...
import torch
import math
from diff_gaussian_rasterization_feature_test_icomma import GaussianRasterizationSettings, GaussianRasterizer
# from icomma_diff_gaussian_rasterization import GaussianRasterizationSettings, GaussianRasterizer
from scene.gaussian_model import GaussianModel
# from scene_.gaussian_model import GaussianModel
from utils.sh_utils import eval_sh


def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, 
           scaling_modifier = 1.0, override_color = None, compute_grad_cov2d=True):
    """
    Render the scene. 
    ...
    var_loss = torch.zeros(1,viewpoint_camera.image_height,
                           viewpoint_camera.image_width) ###d
