...
###################################################
from gaussian_renderer.__init__score import render
from scene_score.gaussian_model_score import GaussianModel
...
def training_report(tb_writer, iteration, Ll1, Ll1_feature, L_score, loss, l1_loss, elapsed, testing_iterations, scene : Scene, renderFunc, renderArgs):
    if tb_writer:
        ...
        tb_writer.add_scalar('train_loss_patches/loss_score', L_score.item(), iteration)
...
def training(model_param, opt_param, pipe_param, testing_iterations, saving_iterations, 
    ...
    for iteration in range(first_iter, opt_param.iterations + 1):
        ...
        # render_pkg["feature_map"], feature_map
        score_map, image, viewspace_point_tensor, visibility_filter, radii = render_pkg["score_map"], \
        ...
        with torch.no_grad():
            ...
            # Log and save
            training_report(tb_writer, iteration, Ll1, Ll1_feature, L_score, loss, l1_loss, 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[5000, 10_000, 15_000, 20_000, 25_000, 30_000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[5000, 20_000, 30_000])
