...
from scene_score.gaussian_model_feature import GaussianModel
...
def training_report(tb_writer, iteration, Ll1, Ll1_feature, L_score, loss, l1_loss, elapsed, 
...
def training(model_param, opt_param, pipe_param, testing_iterations, saving_iterations, 
    ...
    scene = Scene(model_param, gaussians, load_testcam=args.load_testcam,
                  load_ply_with_feature=True, load_iteration=10000)
