...
scene_names=("pgt_7scenes_chess" "pgt_7scenes_office" "pgt_7scenes_stairs") # "pgt_7scenes_redkitchen" 
...
do
    ...
    if (( start_train )); then
        ...
        python -W ignore train_detector.py \
            -s "$SOURSE_PATH" \
            -i "$train_ImgName" \
            -m "$OUT_PATH" \
            -f "$feature_name" \
