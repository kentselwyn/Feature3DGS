...
class MLPDataset(Dataset):
    def __init__(self, all_path):
        ...
        for scene_name in os.listdir(all_path):
            if scene_name.startswith("Cambridge"):
                h_path = f"{all_path}/{scene_name}/desc_data/r1024_SP-k1024-nms4-{scene_name}.h5"
...
MODEL = "SP"
all_path = f"/home/koki/code/cc/feature_3dgs_2/data/vis_loc/gsplatloc/{SCENE}"
# r640_SP-k1024-nms4-pgt_7scenes_stairs-dense
# r1024_SP-k1024-nms4-{NAME}.h5

conf = {
    "dim": None,
    "folder_path": f"{all_path}/mlpckpt",
    "all_path": f"{all_path}",
    # "fea_path": f"{all_path}/desc_data/r640_SP-k1024-nms4-{NAME}-dense.h5",
    "load_ckpt": None,
    "train":{
        "epochs": 5000,
        "start_epoch": 2500,
...
def main(conf):
    ...
    dataset = MLPDataset(conf.all_path)
...
# nohup python -u -m mlp.train_many --dim 16 > /home/koki/code/cc/feature_3dgs_2/log_16_pgt_Cambridge.txt 2>&1 &
# nohup python -u -m mlp.train_many --dim 32 > /home/koki/code/cc/feature_3dgs_2/log_32_pgt_Cambridge.txt 2>&1 &
# nohup python -u -m mlp.train_many --dim 64 > /home/koki/code/cc/feature_3dgs_2/log_64_pgt_Cambridge.txt 2>&1 &
