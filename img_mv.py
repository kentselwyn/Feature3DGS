...
def build_img_feature_allfolders(source_path, folders):
    for name in folders:
        for x in ['A', 'B']:
            ...
            image_len = len(os.listdir(os.path.join(image_path, "img1296x968_raw")))
...
source_path = "/home/koki/code/cc/feature_3dgs_2/all_data"
folders = ['scene0708_00', 'scene0713_00', 'scene0724_00']

# python img_mv.py
if __name__=="__main__":
    build_img_feature_allfolders(source_path, folders)
