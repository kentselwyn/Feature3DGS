...
# python find_match_compressed.py
if __name__=="__main__":
    img_p0 = "/home/koki/code/cc/feature_3dgs_2_copy/data/vis_loc/gsplatloc/7_scenes/pgt_7scenes_stairs/test/rgb/seq-01-frame-000201.color.png"
    img_p1 = "/home/koki/code/cc/feature_3dgs_2_copy/data/vis_loc/gsplatloc/7_scenes/pgt_7scenes_stairs/test/rgb/seq-01-frame-000202.color.png"
    ...
    mlp = get_mlp_vit().cuda()
    desc0 = mlp.back(desc0)
    desc1 = mlp.back(desc1)
    ...
    n0 = Path(img_p0).stem
    n1 = Path(img_p1).stem
    fig.savefig(f"{n0}_{n1}_compressed.png")
