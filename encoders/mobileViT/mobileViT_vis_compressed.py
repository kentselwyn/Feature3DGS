...
if __name__=="__main__":
    # img_path = "/home/koki/code/cc/feature_3dgs_2/data/vis_loc/gsplatloc/7_scenes/pgt_7scenes_stairs/test/rgb/seq-01-frame-000021.color.png"
    ...
    img_path = "/home/koki/code/cc/feature_3dgs_2_copy/data/vis_loc/gsplatloc/7_scenes/pgt_7scenes_stairs/test/rgb/seq-01-frame-000455.color.png"
    ...
    flattened = feature_map.permute(1, 2, 0).reshape(-1, C).cpu()

    mlp = get_mlp_vit().eval()
    flattened = mlp.back(flattened).numpy()
    ...
    plt.savefig(f"{out_name}_feat_compressed.png")
    # breakpoint()

# python mobileViT_vis_compressed.py
